var serviceItems = [
    ...
    {
        name: "Desarrollo de aplicación movil multiplataforma (Android, iOS, Windows)",
        price: "600",
        currency: "$",
        description: "Paquete para las empresas que desean una aplicación movil (Android/IOS) que almacene datos o consuma un servicio web, pero posibilitando el uso de servicios en estas plataformas tan importantes en el mundo movil.",
        feactures: ["Incluye maquetación y creación de aplicación movil", "Exploración y diseño de requerimientos","Procesos de creación transparentes","Prueba y garantía del sistema", "Uso de librerías externas (Según el tipo y la cantidad puede variar el costo)"]
    },
    {
        name: "Desarrollo de aplicación multiplataforma (Movil y Web)",
        price: "900",
        currency: "$",
        description: "Paquete para las empresas que desean una aplicación movil (Android/IOS) y Web que almacene datos y que posean sincronización; posibilitando el uso de servicios en estas plataformas moviles, pero ademas obteniendo una accesibilidad completa desde cualquier dispositivo.",
        feactures: ["Incluye maquetación y creación de pagina web","Incluye maquetación y creación de aplicación movil", "Exploración y diseño de requerimientos","Procesos de creación transparentes","Prueba y garantía del sistema", "Uso de librerías externas (Según el tipo y la cantidad puede variar el costo)","Creación de servicio web","Montaje de la pagina web en un servidor de su preferencia"]
    }
];
